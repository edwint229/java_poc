...
/**
 * Run as below:<br/>
 * java -cp apache-commons-poc-0.0.1-SNAPSHOT.jar:bcel-5.2.jar:. org.apache.bcel.poc.BCELTiming StringBuilder.class buildString
 * @author edwin
 *
 */
public class BCELTiming {
    ...
    private static void addWrapper(ClassGen cgen, Method method) {
        ...
        ilist.append(ifact.createInvoke("java.io.PrintStream", "print", Type.VOID, new Type[] {
            Type.STRING
        ...
        ilist.append(ifact.createInvoke("java.io.PrintStream", "println", Type.VOID, new Type[] {
            Type.STRING
        }, Constants.INVOKEVIRTUAL));
